...
labels = open('labels_plus_{}.csv'.format(dataset_name),'w')
...
for i_ev,event in enumerate(ds.events):
    ...
    for station in ds.ifilter(ds.q.event == event):
        ...
        if snr_here >= snr_thresh and dist_here < dist_max:
            ...
            labels.write('{}/{}.npy, {}, {}, {:6.2f}, {:4.2f}, {:4.2f}, {:4.2f}, {:4.2f}, {:4.2f}\n'.format(outdir,outname,e_type,event_name,dist_here,evlo,evla,evdp,stlo,stla))
